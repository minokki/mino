...
<!--  
	...
	문자를 읽어 오게 된다. 웹 컨테이너가 JSP페이지를 읽을때 사용할 문자셋을 결정하는 과정은
	아래와 같다.
	
	1.  파일의 BOM으로 시작하지 않을 경우
	
		a. 기본 인코딩을 이용해서 파일을 처음부터 읽고 page디렉티브의 pageEncoding속성을 검색
		b. pageEncoding값을 가지고 있을 경우, 파일을 읽을 때 해당 속성 값을 문자셋으로 사용.
		c. pageEncoding 값이 없을 경우 contentType의 charset속성값을 사용
